...
namespace Stocks.Common
{
    ...
    {
        private static double RoundToSignificantDigits(double value, int sigFigures, out int roundingPosition)
        {
        ...
        public static double RoundToSignificantDigits(this double value, int sigFigures)
        {
            int unneededRoundingPosition;
            return RoundToSignificantDigits(value, sigFigures, out unneededRoundingPosition);
        }
        ...
        public static string ToString(this double value, int sigFigures)
        {
            ...
            double roundedValue = RoundToSignificantDigits(value, sigFigures, out roundingPosition);
